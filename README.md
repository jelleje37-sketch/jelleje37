...
### [PulseWell Digital Intake & Client Experience Portal](https://github.com/jelleje37-sketch/jelleje37/tree/main/pulsewell-pmo-portfolio)
...
* **Governance Controls**: Applied Earned Value Management (EVM), formal Change Control Board (CCB) evaluation for wearable health-data sync (CR-001), QA/UAT sign-offs, and Phase Gate 3 operationa[...]
